...
require_once ("elementor/_elementor.php");

require_once ("google-maps/_google-maps.php");
...
require_once("prg-pattern/tk-prg-utils.php");
...
require_once("utils/tk-url-utils.php");
...
require_once("utils/tk-breadcrumbs.php");
